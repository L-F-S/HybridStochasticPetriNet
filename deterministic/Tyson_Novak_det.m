...
k32 = 10;
J_three = 0.04;
k41 = 35; % called k4 in original papers (both Tyson and Novak 2001 and Mura 2008), calling it k41 to have the same name as SPN.py
k42 = 2;  % called k4' in original paper (both Tyson and Novak 2001 and Mura 2008), calling it k42 to have same name as SPN.py
J_four = 0.04;
k51 = 0.005;
k52 = 0.2;
n_exp = 4;
